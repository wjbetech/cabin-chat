...
export default function LandingPage() {
  return (
    <section className="grid w-full gap-10 px-20 lg:grid-cols-[minmax(0,0.95fr)_minmax(320px,1.05fr)] lg:items-center">
      <div className="space-y-6">
        <div className="rounded-4xl border-4 border-[#8b5e3c] bg-[linear-gradient(180deg,#fffef7,#fff3d8)] p-6 shadow-[0_14px_0_#8b5e3c]">
          <h1 className="font-bold text-3xl  lowercase leading-none text-[#5d3b20]">cabin chat</h1>
        </div>
