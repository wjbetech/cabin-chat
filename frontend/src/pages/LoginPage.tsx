  ...
  return (
    <div className="w-full max-w-md rounded-4xl border-4 border-[#8b5e3c] bg-[linear-gradient(180deg,#fffdf6,#fff1d0)] p-4 shadow-[0_14px_0_#8b5e3c]">
      <div className="rounded-3xl border-2 border-[#8b5e3c] bg-white/85 p-6">
        <div>
          <p className="text-sm font-extrabold uppercase tracking-[0.2em] text-[#8b5e3c]">portal entry</p>
          <h1 className="mt-2 font-display text-4xl lowercase text-[#5d3b20]">log in</h1>
          <p className="mt-2 text-sm text-[#6f4a29]">enter the camp to continue your adventure.</p>
        </div>
